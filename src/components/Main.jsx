        ...
        <div className="row mt-5 text-center d-flex justify-content-md-center justify-content-around">
            ...
            <div className="col-6 text-light flex-column align-items-center d-none d-md-flex justify-content-center">
                ...
                <div class="input-group mb-3">
                    <input style={normal_text} type="text" class="form-control bg-dark text-light" placeholder="Email" aria-label="Recipient's username" aria-describedby="button-addon2" required/>
                    <button class="btn btn-outline-light" type="button" id="button-addon2">Receive</button>
                </div>
            </div>
            ...
            <div class="input-group mt-4 d-flex justify-content-center w-xs-75 w-100 d-md-none">
                <input style={normal_text} type="text" class="form-control bg-dark text-light fs-6" placeholder="Email" aria-label="Recipient's username" aria-describedby="button-addon2"/>
                <button class="btn btn-outline-light fs-6 fw-bold" type="button" id="button-addon2">Receive</button>
            </div>
        </div>
    )
}